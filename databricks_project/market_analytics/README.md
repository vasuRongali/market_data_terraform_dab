...
The 'market_analytics' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/market_analytics/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] market_analytics_etl` to your workspace.
